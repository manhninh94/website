...
function initSortTable(objId,sortArray)
{
	...
	/* add down arrow to all be sorted cells */
	for(var no2=0;no2<sortArray.length;no2++){	
		//var ix = document.createElement("IMG");
		//ix.src = "http://travel.aol.com/resources_13/img/down.gif";
		...
		var u = obj.rows[0].cells[no2];
		if(sortArray[no2])obj.rows[0].cells[no2].insertBefore(ft,u.firstChild);
	}	
